"""
Note: Py3 variation/modification cherrypicked from `euclid.py` in this
      repo: https://github.com/ezag/pyeuclid/
      Modification by Kuan Butts (kuanbutts@gmail.com) Sep 01, 2017

Original description:
Euclid graphics maths module. Documentation and tests are included in the file
`euclid.rst`, and at https://github.com/ezag/pyeuclid/blob/master/euclid.rst
"""
